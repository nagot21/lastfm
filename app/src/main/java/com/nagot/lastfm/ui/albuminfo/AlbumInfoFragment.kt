...
class AlbumInfoFragment : BaseFragment(), AlbumInfoFragmentMvpView {
    ...
    /*
    * This class initially would present more information like listeners, play count and top tags
    * but since the time to build a proper layout would take time I preferred to build something
    * clean with a nice visual.
    * */
    ...
    override fun setUp(view: View?) {
        ...
        val album = arguments.getString(ConstantsUtil.ALBUM)
